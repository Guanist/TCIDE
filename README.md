...
- **多模型支持** — DeepSeek / 火山方舟 / Ollama / Anthropic / OpenAI
- **MCP 工具连接** — 接入外部 MCP Server 扩展能力（开发中）
- **LSP 诊断** — 语言服务器实时错误提示（开发中）
- **项目记忆** — 技术栈、编码风格自动学习（规划中）
- **代码熵评估** — 复杂度/重复度/耦合度监控（规划中）
- **Git 智能** — 自动生成 Conventional Commit（规划中）
