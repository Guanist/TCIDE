...
class EntropyEvaluator {
    ...
    _analyzeChurn() {
        ...
        try {
            ...
            const output = child_process.execFileSync('git', ['log', '--pretty=format:', '--name-only', '--since=90 days ago'], { cwd: this.projectRoot, encoding: 'utf-8', timeout: 10000, maxBuffer: 20 * 1024 * 1024 });
